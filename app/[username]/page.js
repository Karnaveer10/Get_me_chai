...
const page = ({ params }) => {
    return (
        <div className=' w-screen bg-gradient-to-r from-red-200 to-yellow-200'>
            ...
            <img className='object-cover relative' src="https://c10.patreonusercontent.com/4/patreon-media/p/campaign/8057130/913fd5edf1c540c082ba5e48271cdfab/eyJ3IjoxNjAwLCJ3ZSI6MX0%3D/6.png?token-hash=szoUQq-tDxL8xMRnZkXYcJEzn_3GBe1QsO_V4ZjO0Zs%3D&token-time=1751587200" alt="" />
            <img width={125} height={125} className='absolute top-[55vh] left-[46vw] rounded-2xl border border-white' src="https://c10.patreonusercontent.com/4/patreon-media/p/campaign/8057130/ae1382f14d7944b4a6f41fdcdbb842f8/eyJoIjozNjAsInciOjM2MH0%3D/1.png?token-hash=7vx-Lch0kri5bKfrZ6CnpJo8NQI_GEqgBc9mOaXp2v4%3D&token-time=1752105600" alt="" />
                ...
                <div className='w-1/2 min-h-[40vh] bg-red-300 rounded-lg p-5 text-center flex flex-col items-center gap-3'>
                    ...
                    <ul className='text-blue-950 text-[13px]'>
                        <li className='flex items-center gap-1'>
                            <img src="avatar.gif" alt="" width={26} />
